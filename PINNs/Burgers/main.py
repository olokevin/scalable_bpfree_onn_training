...
from hc.val_func import val_func_init_from_config
from hc.loss_func import loss_func_init_from_config

# from no_hc.val_func import val_func_init_from_config
# from no_hc.loss_func import loss_func_init_from_config
