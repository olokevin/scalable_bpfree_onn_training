...
def get_transforms(dataset, resize):
    ...
    if dataset == 'mnist':
        ...
        transform_train = transforms.Compose([transforms.Resize(resize, interpolation=InterpolationMode.BILINEAR),transforms.ToTensor(),t])
        # transform_train = transforms.Compose([transforms.ToTensor(),t])

        transform_test = transforms.Compose([transforms.Resize(resize, interpolation=InterpolationMode.BILINEAR),transforms.ToTensor(),t])
...
def get_dataloader(dataset, train_batch_size, test_batch_size, num_workers=2, resize=None, root='../data'):
    transform_train, transform_test = get_transforms(dataset, resize)
